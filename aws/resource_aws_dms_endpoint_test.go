		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(resourceName, "extra_connection_attributes"),
					resource.TestCheckResourceAttr(resourceName, "mongodb_settings.0.auth_type", "password"),
					resource.TestCheckResourceAttr(resourceName, "mongodb_settings.0.auth_mechanism", "default"),
					resource.TestCheckResourceAttr(resourceName, "mongodb_settings.0.nesting_level", "none"),
					resource.TestCheckResourceAttr(resourceName, "mongodb_settings.0.extract_doc_id", "false"),
					resource.TestCheckResourceAttr(resourceName, "mongodb_settings.0.docs_to_investigate", "1000"),
				),
			},
			{
				ResourceName:            resourceName,
